$(document).ready(function () {
    ...
    $('#addPro').click(function () {
        ...
        <button class="savePro" id="savePro_' + proCount + '"><i class="fa-solid fa-floppy-disk"></i>Save</button>\
    ...
    $(document).on('click', 'button.savePro', function () {
        ...
        if (checkBlank) {
            ...
            AjaxCall('/ManageMajor/UpdateMajor', JSON.stringify(profession), "POST").done(function (response) {
                window.location.href = '/ManageMajor/Index';
            }).fail(function (error) {
    ...
    $(document).on('click', 'button.deletePro', function () {
        //var btnId = this.id.substring(10);
        //console.log(btnId);
        //var proId = $('#proId_' + btnId + '').val();
        //console.log(proId);
        //AjaxCall('/SettingMajor/DeleteProfession', JSON.stringify(proId), "POST").done(function (response) {
